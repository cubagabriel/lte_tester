...
class TrafficUtil(object):
    ...
    # Traffic setup
    _remote_ip = ipaddress.IPv4Address("10.128.0.8")
...
class TrafficTest(object):
    ...
    _remote_server = ('10.129.0.2', 62462)
    ...
    def _run(self):
        ...
        try:
            ...
            for i in range(len(instances)):
                ...
                # Add arp table entry
                print('adding arp')
                print(server_instance.ip.exploded, server_instance.mac)
